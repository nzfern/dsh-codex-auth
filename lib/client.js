			...
			return React.createElement("div", { style: { position: "relative" }, ref: panelRef },
				...
				panelOpen
					? React.createElement("div", {
						style: {
							// Fixed to the viewport bottom-right so the panel can
							// never be clipped by the sidebar's overflow or pushed
							// outside the browser window.
							position: "fixed", bottom: "64px", right: "16px", zIndex: 50,
							...
							font: "13px system-ui, sans-serif", lineHeight: 1.6, width: "280px", maxWidth: "calc(100vw - 32px)"
						}
					},
