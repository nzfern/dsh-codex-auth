...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CodexUsageBadge() {
			...
			return React.createElement("div", { style: { position: "fixed", right: "16px", bottom: "16px", zIndex: 40, fontFamily: "system-ui, sans-serif", pointerEvents: "auto" } },
				React.createElement("button", {
					...
					React.createElement("span", null, `Codex 余量 ${remaining}%`)
				),
				// The detail card renders through a portal at the document root so
				// no shell overlay layer, stacking context, or overflow clipping
				// can hide it. Fixed to the viewport, always above the badge.
				open ? createPortal(
					React.createElement("div", { style: { position: "fixed", right: "16px", bottom: "56px", zIndex: 9999, width: "260px", maxWidth: "calc(100vw - 32px)", maxHeight: "calc(100vh - 80px)", overflowY: "auto", background: "var(--dsw-alias-bg-base, #fff)", border: "1px solid var(--dsw-alias-border-l1, #e2e2e2)", borderRadius: "10px", padding: "12px 14px", boxShadow: "0 6px 24px rgba(0,0,0,0.14)", fontSize: "12px", lineHeight: 1.6, color: "var(--dsw-alias-label-primary, #333)", fontFamily: "system-ui, sans-serif" } },
