	...
	factory: (require) => {
		...
		function CodexUsageBadge() {
			...
			return React.createElement("div", { style: { position: "fixed", right: "16px", bottom: "16px", zIndex: 40, fontFamily: "system-ui, sans-serif" } },
				open
					? React.createElement("div", { style: { position: "absolute", right: "0", bottom: "calc(100% + 8px)", width: "260px", background: "var(--dsw-alias-bg-base, #fff)", border: "1px solid var(--dsw-alias-border-l1, #e2e2e2)", borderRadius: "10px", padding: "12px 14px", boxShadow: "0 6px 24px rgba(0,0,0,0.14)", fontSize: "12px", lineHeight: 1.6, color: "var(--dsw-alias-label-primary, #333)" } },
